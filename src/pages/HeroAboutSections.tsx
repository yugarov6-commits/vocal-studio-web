          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="section-eyebrow">О платформе</p>
              </div>
              ...
              <div className="space-y-5 font-cormorant text-lg leading-relaxed" style={{ color: "rgba(208,208,220,0.82)" }}>
                <p>Авторская творческая платформа, основанная Анной Артман — специалистом по всем видам экстремальных техник вокала, горловому и обертональному пению, джазу и современной эстраде.</p>
                ...
                <p>В каталоге платформы — онлайн-курсы, авторские методички, книги и мастер-классы для любого уровня: от полного новичка до практикующего музыканта.</p>
